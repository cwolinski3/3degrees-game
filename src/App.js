...
function App() {
  ...
  // Separate current topic & question states for each player:
  ...
  // Helper getters for the active player's current topic and question.
  ...
  // ----------------------------
  // Helper: clearTurnState – resets per-turn state for the active player.
  // ----------------------------
  ...
  // ----------------------------
  // Pregame: Strength Selection – Player 1 selects 3 strength categories.
  // ----------------------------
  ...
  // ----------------------------
  // Pregame: Weakness Selection – Player 1 selects 3 weakness categories for AI.
  // ----------------------------
  ...
  // AI selections are made independently (they can overlap with Player 1's).
  // ----------------------------
  useEffect(() => {
  ...
  // For Player 1: available = (player1Strengths ∪ aiWeaknesses) minus those already mastered.
  // For AI: available = (aiStrengths ∪ player1Weaknesses) minus those already mastered.
  // ----------------------------
  ...
  // ----------------------------
  // useEffect: When the active player's current topic or degree changes, fetch a new question (with a 100ms delay).
  // ----------------------------
  useEffect(() => {
  ...
  // ----------------------------
  // handleSelectCategory: When a category is chosen, clear previous state and choose a random topic for the active player.
  // ----------------------------
