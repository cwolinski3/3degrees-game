...
function App() {
  ...
  // NEW: currentTopic stores the chosen topic for the selected category.
  ...
  // NEW getQuestion: Uses the fixed currentTopic (set when the category is chosen).
  ...
  // When a category is selected, choose one random topic from that category
  // and store it in currentTopic so that all degree questions come from it.
